...
const RetrunPolicy = () => {
    return (
        ...
        <Helmet>
            <meta charSet="utf-8" />
            <title>Return Policy | Bownbee Australia</title>
            <meta name="description" content="BownBee.com.au's Return and Exchange Policy offers you the option to return or exchange items purchased on bownbee.com.au within 48 hours of receipt."/>
            <meta name="keywords" content="Hassle Free Return for kids Wear, Bownbee, BownbeeAustralia, Bownbeeca" />
        ...
        <ul className="list-disc list-inside"><span className="font-bold uppercase text-lg">How to exchange:</span>
            <li>To request a return, please send mail to <a href="mailto:sales@bownbee.com.au">sales@bownbee.com.au</a> within 48 hrs of receiving the product.</li>
