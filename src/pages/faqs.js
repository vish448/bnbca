...
const FaqsPage = () => {
    return (
        <div id="faqa">
            <Helmet>
            <meta charSet="utf-8" />
            <title>FAQ | Bownbee Australia</title>
            ...
            <meta name="keywords" content="Ethinic wear, Indian Kids,Bownbee, BownbeeAustralia, Bownbeeca" />
        ...
        <div className="lg:container lg:mx-auto p-10">
            ...
            <ol className="list-decimal list-inside">
                <li>Log on to <a href="www.bownbee.com.au">www.bownbee.com.au</a></li>
                <li>Have a look at the wide range of products that we have. All
products are segregated in categories like Girls, Boys, Infants,
Accessories, footwear, Ethnic, Casual.</li>
                <li>You can either search by product name and type, you can also browse each category and click on buy now from the products page.</li>
                <li>All purchases are stored in your shopping cart.</li>
...
of payment.</li>
            ...
            <p>None at all</p><br/>
            <p className="text-2xl font-bold">WHOLESALE ENQURIES!</p>
            <p>If you own a business and are interested in carrying our products please contact us through mail or our contact numnber.</p><br/>
            <p className="text-2xl font-bold">HOW DO I KNOW MY ORDER HAS BEEN CONFIRMED?</p>
            <p>Once your order has been logged and payment authorization has been received, the BownBee team confirms receipt of the order and begins processing it. You will receive an email containing the details of your order when the seller receives it and confirms the same. In this mail you will be provided with a unique Order ID (eg. Order # XXXX), a listing of the item(s) you have ordered and the expected delivery time.</p><br/>
