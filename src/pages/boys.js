                        ...
                        return(
                            <>
                                {productColors.map(color=> {
                                    return(
                                        <p className="cursor-pointer" onClick={()=>setColorFilter(color)} onKeyDown={()=>setColorFilter(color)}><span className={`bg-${color}-400 h-4 w-4 inline-block mt-0 ml-0 mb-0 mr-2`}></span>{color}</p>)
                                })}
                            </>
                        )
                    })}
