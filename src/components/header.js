...
function Header({siteTitle}) {
    return(
            ...
            <div className="h-6 sm:h-10 text-black text-center items-center text-xs sm:text-xl p-1 top-reel font-bold relative"> Australia wide free shipping. 📣</div>
            ...
            <header className="container mx-auto">
                ...
                <div className="grid sm:justify-items-center p-4 grid-cols-3 justify-items-end">
                    ...
                    <div className="grid justify-items-end self-center grid-cols-2 hidden md:block"><MdCall className="float-left m-1 text-yellow-color"/><a href="tel:0435593556">+61 435 593 556</a></div>
                    ...
                    <div className="header-right grid sm:grid-cols-2 justify-items-center items-center ">
                        <button className="snipcart-checkout inline-block align-middle pr-4 sm:pr-0">
