            ...
            <div className="grid grid-cols-1 justify-items-center sm:justify-items-start sm:grid-cols-2 gap-10 p-14 container mx-auto">
                ...
                <div>
                    ...
                    <div className="product-details mb-4">
                        ...
                        <b>Specifications</b>
                        <div>Id - {data.productsCsv.id}</div>
                    ...
                    <button className={`btn bg-green-500 mt-4 snipcart-add-item p-4 rounded text-white ${data.productsCsv.stock == 0 ? 'hidden': ''}`}                            data-item-id={data.productsCsv.id}
                            data-item-price={data.productsCsv.discountedPrice}
                            data-item-url={`https://bownbee.com.au/${data.productsCsv.productCategory}/${data.productsCsv.fields.slug}`}
                            data-item-name={data.productsCsv.name}
                            data-item-image={`https://bownbee.com.au` + productImage}
