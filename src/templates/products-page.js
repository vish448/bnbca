                                    ...
                                    if(variant.stock != 0){
                                        return (
                                            <>
                                                ...
                                                onKeyDown={() => {toggleSize(index); setSize(variant.variation[0].option)}} key={index}>{variant.variation[0].option} - {variant.stock}</button>
                                        ...
                                        return(
                                            <button className={`p-2 border-red-200 border mr-2 mb-2 ${variant.stock == 0 ?'bg-gray-100 text-gray-500 cursor-default outOfStock': null}`} disabled role="button" tabIndex={0}>{variant.variation[0].option} - {variant.stock}</button>
                                        )
                                    }
                                })
